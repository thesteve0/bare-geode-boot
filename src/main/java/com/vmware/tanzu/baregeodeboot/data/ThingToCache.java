 ...
 * object is read out of the cache. The rest is all set when the object is created and can not even be set through
 * the constructor.
 */
public class ThingToCache {
    ...
    //This does not guarantee unique names, but it is good enough for the demo
